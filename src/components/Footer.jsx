    ...
    <footer className="bg-background text-foreground">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="text-primary font-bold text-xl">AAT</div>
          ...
          <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
            {[
              ...
              { name: "GitHub", path: "#", icon: GithubIcon },
              { name: "Dribbble", path: "#", icon: DribbbleIcon },
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-border pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
          {[
            ...
            <div key={col.heading}>
              <p className="font-medium">{col.heading}</p>
        ...
        <p className="text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} AAT. All rights reserved.
        </p>
      </div>
    </footer>
  );
...
/* --- Simple SVG icon components (keeps JSX clean) --- */
