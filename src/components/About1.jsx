  ...
  return (
    <section className='grid md:grid-cols-2 max-w-7xl mx-auto gap-8 bg-accent my-10 rounded-lg p-8 md:p-12'>
        ...
        <div className='flex flex-col justify-center px-4 space-y-6'>
            <h2 className='font-extrabold text-3xl md:text-4xl text-chart-2'>About AAT</h2>
            <div className='space-y-4'>
                <p className='text-lg leading-relaxed'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis aliquid quam quos itaque eos accusantium,
                    cumque dolor corrupti doloremque deserunt ratione enim unde maxime, vero neque maiores facilis! Delectus, necessitatibus?
                </p>
                <p className='text-lg leading-relaxed'>
                    Additional content can go here to make the section more informative and engaging.
                </p>
        ...
        <div className='group relative'>
            ...
            <div className='absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500'>
                <span className='text-white text-2xl font-bold transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500'>ABOUT US</span>
            </div>
        </div>
    </section>
  )
